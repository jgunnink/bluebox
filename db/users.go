...
var _ bluebox.UserService = &UserService{}
...
func (us *UserService) UserCreate(user *bluebox.User) (*bluebox.User, error) {
	details := &MethodInfo{
		Name:        "UserCreate",
		Description: "UserCreate is the DB method used to UserCreate",
	}
	newUser := &bluebox.User{}
	query := fmt.Sprintf(`
...
func (us *UserService) UserAll() (map[int]*bluebox.User, error) {
	details := &MethodInfo{
		Name:        "UserAll",
...
`, userAllColumns)
	...
	result := map[int]*bluebox.User{}
	for rows.Next() {
		tempUser := &bluebox.User{}
...
func (us *UserService) UserArchive(id int) (*bluebox.User, error) {
	details := &MethodInfo{
		Name:        "UserArchive",
...
func (us *UserService) UserUnarchive(id int) (*bluebox.User, error) {
	details := &MethodInfo{
		Name:        "UserUnarchive",
...
func (us *UserService) UserDisable(id int) (*bluebox.User, error) {
	details := &MethodInfo{
		Name:        "UserDisable",
...
func (us *UserService) UserEnable(id int) (*bluebox.User, error) {
	details := &MethodInfo{
		Name:        "UserEnable",
...
func (us *UserService) UserByEmail(email string) (*bluebox.User, error) {
	details := &MethodInfo{
		Name:        "UserByEmail",
...
func (us *UserService) UserByID(id int) (*bluebox.User, error) {
	details := &MethodInfo{
		Name:        "UserByID",
...
func (us *UserService) UserSetToken(id int, sessionToken string) (*bluebox.User, error) {
	details := &MethodInfo{
		Name:        "UserSetToken",
...
func (us *UserService) UserUpdate(user *bluebox.User) (*bluebox.User, error) {
	details := &MethodInfo{
		Name:        "UserUpdate",
...
// password in the database.
func (us *UserService) UserSetPassword(id int, hashedPassword string) (*bluebox.User, error) {
	details := &MethodInfo{
