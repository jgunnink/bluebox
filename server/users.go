...
func NewUserController(mw bluebox.MiddlewareService, us bluebox.UserService) *UserController {
	...
	result.Mux.GET("/users/:id/get", mw.InsecureChain(result.UserByID))
...
func (uc *UserController) UserCreate(w http.ResponseWriter, r *http.Request) {
	...
	userCreateRequest := &bluebox.UserCreateRequest{}
...
func (uc *UserController) UserSetResetToken(w http.ResponseWriter, r *http.Request) {
	...
	from := mail.NewEmail("Bluebox Admin", "noreply@blueboxapp.com")
	subject := "Reset your Bluebox password"
...
<p>Regards from Bluebox admin team</p>`)
...
func (uc *UserController) UserPasswordReset(w http.ResponseWriter, r *http.Request) {
	...
	request := &bluebox.UserPasswordReset{}
