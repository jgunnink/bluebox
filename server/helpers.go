...
func LoadCookie(r *http.Request, cs *sessions.CookieStore) (*bluebox.Cookie, error) {
...
func updateCookieSession(cookie *bluebox.Cookie, session *sessions.Session) *sessions.Session {
