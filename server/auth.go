...
func NewAuthController(mw bluebox.MiddlewareService, as bluebox.AuthService, us bluebox.UserService) *AuthController {
...
func (ac *AuthController) SignIn(w http.ResponseWriter, r *http.Request) {
	...
	userFromRequest := &bluebox.UserSignInRequest{}
